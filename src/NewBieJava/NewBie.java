...
public class NewBie extends AdvancedRobot {
    ...
    public void onScannedMedicalKit(ScannedMedicalKitEvent e){
    	if(e.getHealEnergy() >= 10){
    ...
    public void onScannedRobot(ScannedRobotEvent e) {
        ...
        if (changeInEnergy>0 && changeInEnergy<=3) {
             ...
             if (getTime() % 20 == 0) {
            	 movementDirection *= -1;
            	 setAhead((e.getDistance()/3 + 100) * movementDirection);
             }
